...
from LHNS.problems.optimization.tsp_gls.utils import utils
from LHNS.problems.optimization.tsp_gls.gls import gls_evol
...
def solve_instance(n,opt_cost,dis_matrix,coord,time_limit, ite_max, perturbation_moves,heuristic):
    ...
    exec(heuristic, heuristic_module.__dict__)

    # Add the module to sys.modules so it can be imported
    sys.modules[heuristic_module.__name__] = heuristic_module
    heuristic = heuristic_module
