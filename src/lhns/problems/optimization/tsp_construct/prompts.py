...
Help me design a novel algorithm that is different from the algorithms in literature to select the next node in each step."
        ...
        self.prompt_other_inf = "All are Numpy arrays. IMPORTANT: Your function MUST return a single integer value stored in the variable 'next_node'. Make sure to define and return 'next_node' explicitly."
