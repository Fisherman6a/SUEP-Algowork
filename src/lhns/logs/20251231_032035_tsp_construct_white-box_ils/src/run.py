...
class TSPCONST():
    def __init__(self, problem_type='white-box') -> None:
        ...
        with open('problems/optimization/tsp_construct/instances.pkl', 'rb') as f:
            self.instance_data = pickle.load(f)
        ...
        for instance, distance_matrix in self.instance_data:
            ...
            for i in range(1,self.problem_size-1):
                ...
                if self.problem_type == 'white-box':
                    ...
                    next_node = eva.heuristics(current_node, destination_node, unvisited_near_nodes, distance_matrix)
